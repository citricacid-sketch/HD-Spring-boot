...
public class TripPrepareRequest {
    ...
    // Constructors
    public TripPrepareRequest() {
    }

    public TripPrepareRequest(TravelPlan travelPlan, String userId, boolean mergeWithExisting, String targetTripId) {
